...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'template_template', (
            ...
            ('plugin', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['plugin.Plugin'], null=True)),
        ...
        db.send_create_signal(u'template', ['Template'])


    def backwards(self, orm):
        # Deleting model 'Template'
        db.delete_table(u'template_template')
